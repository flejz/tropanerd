...
class PostImagesControllerTest < ActionController::TestCase
  ...
  test "should create post_image" do
    assert_difference('PostImage.count') do
      post :create, post_image: { description: @post_image.description, image: @post_image.image, post_id: @post_image.post_id }
    end
  ...
  test "should update post_image" do
    patch :update, id: @post_image, post_image: { description: @post_image.description, image: @post_image.image, post_id: @post_image.post_id }
    assert_redirected_to post_image_path(assigns(:post_image))
  end
